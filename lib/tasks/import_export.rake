namespace :import_export do
  ...
  task hrdw_com_month_report_import: :environment do
    Hrdw::ComMonthReport.all.each do |c|
      ...
      staff_now.update(start_date: "#{c.pmonth}-01",
      ...
      work_shanghai.update(start_date: "#{c.pmonth}-01",
      ...
      construction_design_electrical.update(start_date: "#{c.pmonth}-01",
      ...
      profession_draw_design.update(start_date: "#{c.pmonth}-01",
      ...
      construction_draw_design.update(start_date: "#{c.pmonth}-01",
      ...
      profession_construction.update(start_date: "#{c.pmonth}-01",
      ...
      profession_electrical.update(start_date: "#{c.pmonth}-01",
