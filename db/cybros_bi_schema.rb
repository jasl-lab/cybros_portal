...
ActiveRecord::Schema.define(version: 2020_10_09_011647) do
  ...
  create_table "CRM_CLIENT_RECEIVE", id: false, charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
    ...
    t.float "acc_receive", limit: 53
    t.float "acc_receive_lt3_months", limit: 53
    t.float "acc_receive_4to12_months", limit: 53
    t.float "acc_receive_gt1_years", limit: 53
    t.integer "cricrank"
  ...
  create_table "CRM_CONCRACT_INFO", id: false, charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
    ...
    t.text "crmcode"
    t.text "crmshort"
    t.float "cricyear", limit: 53
    t.text "crmbusiunitcode"
    t.text "crmbusiunitname"
  end
