...
ActiveRecord::Schema.define(version: 2021_05_27_054732) do
  ...
  create_table "baseline_position_accesses", charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
    t.string "b_postcode"
    t.string "b_postname"
