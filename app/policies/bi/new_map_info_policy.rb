...
module Bi
  class NewMapInfoPolicy < BasePolicy
    ALLOW_SHOW_TITLES = %w[商务经理 管理副所长 所长助理 所长 市场总监 总经理助理 副总经理 总经理 运营分析经理 市场运营中心经理].freeze
    ALLOW_DOWNLOAD_HQ_TITLES = %w[管理副所长 所长助理 所长 市场总监 总经理助理 副总经理 总经理 运营分析经理 市场运营中心经理].freeze
