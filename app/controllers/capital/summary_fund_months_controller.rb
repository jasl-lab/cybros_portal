...
class Capital::SummaryFundMonthsController < Capital::BaseController
  ...
  def show
    ...
    @redirect_url = 'view/report?op=write&viewlet=FR/Finance/CWDailyFillMonthReport.cpt&ref_t=design'
