...
module Person
  class ProofOfIncomesController < ApplicationController
    ...
    def show
      ...
      render partial: 'shared/show_task_detail', locals: { show_task_detail_return_path: person_proof_of_incomes_path, result: @result }
    end
    ...
    private
      ...
      def set_8_predefined_field
        ...
        if current_user_department.present?
          ...
          @proof_of_income_apply.contract_belong_company = Nc::PsndocCtrt.contract_belong_company(current_user.clerk_code)
