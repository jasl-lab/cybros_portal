  ...
  class ProofOfIncomesController < ApplicationController
    ...
    def new
      ...
      if current_user_department.present?
        ...
        @proof_of_income_apply.contract_belong_company = current_user_department.company_name
        @proof_of_income_apply.contract_belong_company_code = current_user_department.company_code
      end
    end
    ...
    def start_approve
      ...
      bizData = {
        ...
        attachment_list: [ { file_name: @proof_of_income_apply.attachment.filename.to_s, url: rails_blob_url(@proof_of_income_apply.attachment) } ],
