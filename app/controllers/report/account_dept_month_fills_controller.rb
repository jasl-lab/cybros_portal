...
class Report::AccountDeptMonthFillsController < Report::BaseController
  ...
  def show
    authorize :"Bi::AccountDeptYearFill"
    prepare_meta_tags title: t(".title")
    @redirect_url = "view/report?op=write&viewlet=FR/Finance/SubCompanyFillMonth.cpt&ref_t=design"
