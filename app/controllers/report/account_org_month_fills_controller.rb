...
class Report::AccountOrgMonthFillsController < Report::BaseController
  ...
  def show
    authorize :"Bi::AccountOrgMonthFill"
    prepare_meta_tags title: t(".title")
    @redirect_url = "view/report?op=write&viewlet=FR/Finance/OrganizationFillMonth.cpt&ref_t=design"
