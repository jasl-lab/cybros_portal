...
class Report::BonusDistributionsController < Report::BaseController
  ...
  def show
    ...
    @redirect_url = "view/report?viewlet=FR/Finance/奖金分配.cpt&ref_t=design&op=view&ref_c=16a27647-5aaf-48a6-b1fb-8496756a6a9e"
