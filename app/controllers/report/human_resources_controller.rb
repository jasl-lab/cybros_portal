...
class Report::HumanResourcesController < Report::BaseController
  ...
  def show
    ...
    @redirect_url = ERB::Util.url_encode "view/form?viewlet=HR/SY_JT.frm&ref_t=design&ref_c=7c332fd4-ca53-4731-8200-9147e584be33"
