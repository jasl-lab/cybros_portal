...
class Report::AccountDeptYearFillsController < Report::BaseController
  ...
  def show
    ...
    @redirect_url = "view/report?op=write&viewlet=FR/Finance/SubCompanyFillYear.cpt&ref_t=design"
