  ...
  class ProofOfIncomeDatatable < ApplicationDatatable
    ...
    def view_columns
      @view_columns ||= {
        ...
        created_at: { source: 'Personal::ProofOfIncomeApply.created_at', searchable: false, orderable: true },
        task_id: { source: 'Personal::ProofOfIncomeApply.begin_task_id', cond: :string_eq, searchable: true, orderable: true },
        task_status: { source: 'Personal::ProofOfIncomeApply.status', searchable: false, orderable: true },
    ...
    def data
      records.map do |r|
        ...
        see_attachments = r.attachments.collect do |attachment|
          link_to attachment.filename, view_attachment_person_proof_of_income_path(r, attachment_id: attachment.id), remote: true
        end
