...
append :linked_dirs, 'log', 'storage', 'tmp/pids', 'tmp/cache', 'tmp/sockets', 'public/system', 'public/knowledge_images', 'public/packs', 'public/default_name_card', 'public/images/weixin', 'node_modules'
